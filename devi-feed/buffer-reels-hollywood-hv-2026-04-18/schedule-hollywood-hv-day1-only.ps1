# Schedule only HV day-1 reels (8 slots) to Devi IG + FB via Buffer.
...
#
# Prereq: MP4s on HTTPS (push hv-20260418-01..08 to main or set -MediaBaseUrl).
# Requires: local-secrets/buffer_access_token.txt, buffer_ids.ps1 with
#   BUFFER_PROFILE_IG_DEVI, BUFFER_PROFILE_FB_PAGE_DEVI
#
# From repo root:
#   powershell -ExecutionPolicy Bypass -File devi-feed/buffer-reels-hollywood-hv-2026-04-18/schedule-hollywood-hv-day1-only.ps1
#
# Optional:
...
$posts = @(
  ...
  @{ file = "hv-20260418-05.mp4"; caption = "Feathers. Haze. Fire."; tags = "#devi #fashion #editorial #AIFashion" },
  @{ file = "hv-20260418-06.mp4"; caption = "Desert disco. Silver hat."; tags = "#devi #fitness #dance #festival #AIFashion" },
  @{ file = "hv-20260418-07.mp4"; caption = "Lace lift. Core tight."; tags = "#devi #fitness #beauty #AIFashion" },
  @{ file = "hv-20260418-08.mp4"; caption = "White noise. Big flash."; tags = "#devi #fashion #trend #AIFashion" }
)

# Slot clock times (UTC) — same grid as schedule-manifest day 1
$clock = @(
  @{ h = 11; m = 0 },
  @{ h = 12; m = 45 },
  @{ h = 14; m = 30 },
...
Write-Host "HV day-1 anchor date (UTC): $($anchor.ToString('yyyy-MM-dd'))"
...
Write-Host "Done. Queued 8 HV day-1 reels x2 (IG+FB). Confirm raw GitHub URLs return 200 for each MP4 before due times."
