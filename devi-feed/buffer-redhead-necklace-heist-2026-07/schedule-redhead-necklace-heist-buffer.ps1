# Queue redhead necklace-heist stop-motion reel to Buffer (Devi IG).
#
...
# powershell -ExecutionPolicy Bypass -File devi-feed/buffer-redhead-necklace-heist-2026-07/schedule-redhead-necklace-heist-buffer.ps1 -DryRun
...
$manifestPath = Join-Path $packDir "schedule-buffer-redhead-necklace-heist.json"
...
$reelFile = "fia-redhead-necklace-heist-reel.mp4"
$deliveryReel = Join-Path $repoRoot "buffer-delivery\$reelFile"
$sourceReel = Join-Path $repoRoot "contenty\product-campaigns\2026-07-07-fia-stop-motion-necklace-thief\fia-redhead-necklace-heist-signed-reel.mp4"
