...
Use this skill to turn a **real builder moment** into comic **story beats**, **visual direction**, and **image caption** options. It does **not** write the full LinkedIn post. For feed-ready copy, hand off to **`/linkedin-native-post-skill`** ([`linkedin_native_post_skill.md`](./linkedin_native_post_skill.md)); you can also use [`generation_prompt.md`](./generation_prompt.md) / [`comic_post_template.md`](./comic_post_template.md) for manual drafting.
